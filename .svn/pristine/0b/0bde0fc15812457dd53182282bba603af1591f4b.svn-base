...
void hal_spi_init ()
{
  ...
  /* Config GPIOs */
  /* Configure SCK, MISO and MOSI as Alternative Function PP */
  GPIO_InitStructure.Pin = LORA_SCK_PIN;
  GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStructure.Pull = GPIO_PULLDOWN;
  GPIO_InitStructure.Alternate = GPIO_AF5_SPI1;
  HAL_GPIO_Init(LORA_SCK_PORT, &GPIO_InitStructure);

  GPIO_InitStructure.Pin = LORA_MISO_PIN;
  HAL_GPIO_Init(LORA_MISO_PORT, &GPIO_InitStructure);

  GPIO_InitStructure.Pin = LORA_MOSI_PIN;
  HAL_GPIO_Init(LORA_MOSI_PORT, &GPIO_InitStructure);
