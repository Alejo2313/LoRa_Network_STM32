...
static uint8_t channels_p[] = {CHANNEL_5, CHANNEL_7, CHANNEL_9, CHANNEL_11, CHANNEL_13, CHANNEL_15};
static uint8_t channels_n[] = {CHANNEL_6, CHANNEL_8, CHANNEL_10, CHANNEL_12, CHANNEL_14, CHANNEL_16};
static uint8_t analog[] = {CHANNEL_2, CHANNEL_3, CHANNEL_4};

static uint32_t anen[] = {GPIO_PIN_5, GPIO_PIN_8, GPIO_PIN_9};
...
//TODO -> DELETE THIIIIIS!!!!!
	...
	for(cont = 0; cont < ANALOGS; cont++){
		val = (uint16_t)(ExtADC_ReadVoltageInput(analog[cont]));
